...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const spots = [
        { top: "15%", left: "40%", size: 360 },  // Position and size for spot 1
        { top: "2%", left: "65%", size: 260 },  // Position and size for spot 2
        { top: "50%", left: "50%", size: 330 },  // Position and size for spot 3
        { top: "50%", left: "25%", size: 230 },  // Position and size for spot 4
        { top: "75%", left: "80%", size: 250 },  // Position and size for spot 5
...
const popupTexts = { //made this info up just as a filler for the presentation
    "man": `
    <h2>The Statue</h2>   
    <ul>
    <li>The Colossus of Rhodes was made from bronze, then reinforced with iron. It stood on a white marble base.</li>
    <li>The exact pose of the statue is unknown but it was potentially shielding its eyes from the sun.</li>
    <li>There is a <span class="clickable-word" data-word="Misconception">misconception</span> that the statue was straddling the harbour entrance but it would have been physically impossible to create it that way. It is much more likely that it was standing near the harbour entrance instead.</li>
    </ul>
    `,
};
...
const allowedParts = ["man"]                                 //list of the items named in blender which are selectable / will produce a pop up when the ray intersects on mouse down
...
const definitions = {
    "Siege": [{ title: "Siege", text: "The surrounding of a place by armed forces in order to take it from those defending it." }],
    "Misconception": [{ title: "Misconception", text: "A belief that is incorrect due to a failure to understand something." }],
}
