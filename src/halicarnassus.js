...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const spots = [
        { top: "2%", left: "65%", size: 260 },  // Position and size for spot 2
        { top: "50%", left: "50%", size: 330 },  // Position and size for spot 3
        { top: "50%", left: "18%", size: 230 },  // Position and size for spot 4
        { top: "50%", left: "90%", size: 250 },  // Position and size for spot 5
        { top: "80%", left: "30%", size: 240 },  // Position and size for spot 6
        { top: "5%", left: "25%", size: 290 },  // Position and size for spot 6
        { top: "5%", left: "1%", size: 270 },  // Position and size for spot 6
    ];
...
const popupTexts = {
    "statues": `
    <h2>Sculpture Decorations</h2>
    <ul>
        <li>There were many detailed sculptures carved into the external walls of the podium of the mausoleum.</li>
        <li>These likely depicted the life of King Mausolus and his hopes for the <span class="clickable-word" data-word="Afterlife">afterlife</span>.</li>
    </ul>
    `,
    "four_horse_chariot": `
    <h2>Four Horse Chariot</h2>
    <ul>
        <li>This was a detailed sculpture made from marble and depicted a four horse chariot.</li>
        <li>There are large fragments that survived the earthquake and are now held in the British Museum. </li>
    </ul>
    `,
};
...
const allowedParts = ["statues", "four_horse_chariot"]                                 //list of the items named in blender which are selectable / will produce a pop up when the ray intersects on mouse down
...
const definitions = {
    "Mausoleum": [{ title: "Mausoleum", text: "A building where dead people are buried." }],
    "11th-15th century": [{ title: "11th - 15th Century", text: "The years 1001 - 1500 AD." }],
    "Afterlife": [{ title: "Afterlife", text: "The years 2001 - 2100 AD." }],
}
