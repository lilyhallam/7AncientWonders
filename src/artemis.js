...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const spots = [
        { top: "10%", left: "20%", size: 220 },  // Position and size for spot 1
        { top: "50%", left: "30%", size: 200 },  // Position and size for spot 2
        { top: "70%", left: "55%", size: 250 },  // Position and size for spot 3
        { top: "80%", left: "15%", size: 290 },  // Position and size for spot 4
        { top: "20%", left: "65%", size: 250 },  // Position and size for spot 5
        { top: "55%", left: "90%", size: 240 },  // Position and size for spot 6
    ];
...
//POP UP INFO
const allowedParts = ["Roof_Decs_Top", "roof_selectable"] 

const popupGroups = {}
const popupGroupings = {
    "ArtPop" : ["Roof_Decs_Top", "roof_selectable"],
}
...
const popupTexts = { 
    ...
    <h2>Artworks</h2>   
    <ul>
        <li>The temple was known for the artworks that adorned the outer and inner walls.</li>
        <li>These depicted the goddess artemis as well as references to Ephesus.</li>
        <li>There were also more on the second version of the temple than were on the first.</li>
    </ul>
    `,
};
...
const hoverGroups = {
    "Roof_Decs_Top": [
        { name: "Roof_Decs_Top", color: 0xFFF8DC},
        { name: "roof_selectable", color: 0x000000},
    ],
    "roof_selectable": [
        { name: "Roof_Decs_Top", color: 0xFFF8DC},
        { name: "roof_selectable", color: 0x000000},
...
if(model) {                                                                         
    ...
    if (intersects.length > 0) {
        ...
        console.log("Hovering over:", hoveredObject.name);
    }
...
const definitions = {
    "Goths": [{ title: "Goths", text: "A member of a Germanic people that harassed the Roman Empire with their two branches that spread across modern day Germany, France, Spain and Italy." }],
}
